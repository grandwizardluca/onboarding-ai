# SYSTEM_PROMPT.md — Socratic.sg
**This is the default system prompt. Load this into the system_prompts table on first run.**
**The admin can edit this at any time through /admin/prompt without touching this file.**
